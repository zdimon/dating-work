...
sio = socketio.AsyncServer(async_mode='tornado', cors_allowed_origins=['http://localhost:4200','https://dating-test.webmonstr.com', 'http://localhost'],client_manager=mgr)
